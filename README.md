...
| `VORTEX_VOICE` | `en-US-EmmaMultilingualNeural` | edge-tts voice — chosen 2026-09-02 after the user compared 5 real generated samples (see `IMPLEMENTED.md`'s Phase 1 row) |
